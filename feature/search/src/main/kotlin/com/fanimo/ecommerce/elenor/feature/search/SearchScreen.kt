...
import com.fanimo.ecommerce.core.ui.NewsFeedUiState.Success
import com.fanimo.ecommerce.core.ui.R.string
...
import com.fanimo.ecommerce.elenor.feature.home.HomeViewModel
//import com.fanimo.ecommerce.elenor.feature.home.ProductViewModel
//import com.fanimo.ecommerce.feature.favorite.FavoriteItem
//import com.fanimo.ecommerce.feature.favorite.FavoriteViewModel
import com.fanimo.ecommerce.elenor.feature.search.R as searchR
...
internal fun SearchRoute(
    ...
    /* val recentSearchQueriesUiState by searchViewModel.recentSearchQueriesUiState.collectAsStateWithLifecycle()
     ...
     SearchScreen(
         ...
         onFollowButtonClick = favoriteViewModel::followTopic,
         onFavoriteClick = onFavoriteClick,
         onSearchQueryChanged = searchViewModel::onSearchQueryChanged,
         onSearchTriggered = searchViewModel::onSearchTriggered,
         onTopicClick = onTopicClick,
         onNewsResourcesCheckedChanged = homeViewModel::updateNewsResourceSaved,
...
fun EmptySearchResultBody(
    ...
    Column(
        ...
        val favorite = stringResource(id = searchR.string.favorite)
        val tryAnotherSearchString = buildAnnotatedString {
            ...
            withStyle(
                ...
                pushStringAnnotation(tag = favorite, annotation = favorite)
                append(favorite)
            }
            append(" ")
...
private fun SearchToolbar(
    ...
    Row(
        ...
        IconButton(onClick = { onBackClick() }) {
            Icon(
                imageVector = EleIcons.ArrowBack,
                contentDescription = stringResource(
                    id = string.back,
                ),
            )
