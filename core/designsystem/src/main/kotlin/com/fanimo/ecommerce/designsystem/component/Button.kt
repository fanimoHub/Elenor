...
fun EleOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = EleButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = EleButtonDefaults.DisabledOutlinedButtonBorderAlpha,
                )
            },
        ),
        contentPadding = contentPadding,
...
@ThemePreviews
@Composable
fun EleButtonPreview() {
    EleTheme {
        EleBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            EleButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun EleOutlinedButtonPreview() {
    EleTheme() {
        EleBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            EleOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun EleButtonLeadingIconPreview() {
    EleTheme {
        EleBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            EleButton(
                onClick = {},
                text = { Text("Test button") },
                leadingIcon = { Icon(imageVector = EleIcons.Add, contentDescription = null) },
            )
        }
    }
}
