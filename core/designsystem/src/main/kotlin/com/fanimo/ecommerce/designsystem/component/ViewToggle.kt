...
fun EleViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = EleViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        EleViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) EleIcons.ViewDay else EleIcons.ShortText,
 ...
 */
@Composable
private fun EleViewToggleButtonContent(
